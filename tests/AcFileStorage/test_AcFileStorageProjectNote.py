...
class TestAcFileStorageProjectNote(TestCase):
    ...
    def test_save_with_attachments(self):
        ...
        project = project_note_from_json(
            self._generate_test_project_note_with_2_attachments(4)
        )
    ...
    def test_save_with_attachments_wrong_class(self):
        ...
        project_note = project_note_from_json(
            self._generate_test_project_note_with_2_attachments(40)
        )
        project_note.class_ = "dummy"
        with self.assertRaises(AssertionError) as cm:
            storage.save(project_note)
    ...
    @skipIf(True, "attachments not yet implemented")
