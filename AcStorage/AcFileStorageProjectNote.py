...
class AcFileStorageProjectNote:
    ...
    @staticmethod
    def get_filename(project: AcProjectNote) -> str:
        return "project-note-%08d.json" % project.id
    ...
    def save(self, project_note: AcProjectNote) -> str:
        ...
        project_note_filename = self.get_filename(project_note)
        project_note_full_filename = self.get_full_filename(project_note_filename)
